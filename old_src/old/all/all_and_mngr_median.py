...
def loss_with_per_tree_stats(df, new_cols):
    ...
    estimator = xgb.XGBClassifier(n_estimators=1500, objective='mlogloss', subsample=0.8, colsample_bytree=0.8)
...
do_test_with_xgboost_stats_per_tree(1000, 'manager_num_and_median_08_08.json')
