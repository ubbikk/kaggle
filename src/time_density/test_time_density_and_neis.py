...
def loss_with_per_tree_stats(df, new_cols):
    ...
    train_df, test_df, new_cols = process_time_density_and_nei(train_df, test_df)
    train_df, test_df = shuffle_df(train_df), shuffle_df(test_df)
    features += new_cols
...
do_test_with_xgboost_stats_per_tree(1000, 'all_and_nei123_08_08_concat', sys.argv[1])
