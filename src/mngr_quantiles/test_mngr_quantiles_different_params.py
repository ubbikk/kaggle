...
def loss_with_per_tree_stats(df, new_cols):
    ...
    estimator = xgb.XGBClassifier(n_estimators=1100, objective='mlogloss',
                                  subsample=0.7, colsample_bytree=0.7, learning_rate=0.03, max_depth=6)
...
do_test_with_xgboost_stats_per_tree(1000, 'test_mngr_quantiles_different_params', sys.argv[1])
