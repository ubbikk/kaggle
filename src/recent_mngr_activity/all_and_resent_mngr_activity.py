...
def loss_with_per_tree_stats(df, new_cols):
    ...
    train_df, test_df, new_cols = process_recent_mngr_activity(train_df, test_df)
    train_df, test_df = shuffle_df(train_df), shuffle_df(test_df)
    features += new_cols
...
do_test_with_xgboost_stats_per_tree(1000, 'all_and_resent_mngr_activity_0_1', sys.argv[1])

"""
features = ['bathrooms', 'bedrooms', 'latitude', 'longitude', 'price', 'num_features', 'num_photos',
'word_num_in_descr', 'created_month', 'created_day', 'created_hour', 'created_minute', 'dayOfWeek',
 'elevator', 'hardwood floors', 'cats allowed', 'dogs allowed', 'doorman', 'dishwasher',
  'laundry in building', 'no fee', 'reduced fee', 'fitness center', 'pre-war', 'roof deck',
   'outdoor space', 'common outdoor space', 'private outdoor space', 'dining room',
   'high speed internet', 'balcony', 'swimming pool', 'new construction', 'terrace',
   'exclusive', 'loft', 'garden/patio', 'wheelchair access', 'fireplace', 'simplex',
    'lowrise', 'garage', 'furnished', 'multi-level', 'high ceilings', 'parking space',
    'live in super', 'renovated', 'green building', 'storage', 'washer', 'stainless steel appliances',
     'hcc_manager_id_target_high', 'hcc_manager_id_target_medium', 'manager_num',
     'hcc_building_id_target_high', 'hcc_building_id_target_medium', 'bid_num',
     'listing_id', 'freq_of_nei1', 'freq_of_nei2', 'freq_of_nei1, with bed=0',
      'freq_of_nei1, with bed=1', 'freq_of_nei1, with bed=2', 'freq_of_nei1, with bed=3',
       'freq_of_nei2, with bed=0', 'freq_of_nei2, with bed=1', 'freq_of_nei2, with bed=2',
       'freq_of_nei2, with bed=3', 'freq_of_nei3, with bed=0', 'freq_of_nei3, with bed=1',
       'freq_of_nei3, with bed=2', 'freq_of_nei3, with bed=3', 'median_ratio_of_nei1',
       'median_ratio_of_nei2', 'nei1_fordham manor', 'nei1_downtown brooklyn',
        'nei1_dyker heights', 'nei1_little italy', 'nei1_long island city',
         'nei1_murray hill', 'nei1_rockaway beach', 'nei1_concourse', 'nei1_richmond hill',
          'nei1_bedford-stuyvesant', 'nei1_midtown east', 'nei1_university heights',
          'nei1_not_mapped_yet', 'nei1_coney island', 'nei1_belmont', 'nei1_kew gardens hills',
           'nei1_midwood', 'nei1_gravesend', 'nei1_red hook', 'nei1_forest hills', 'nei1_marble hill',
            'nei1_wakefield', 'nei1_williamsbridge', 'nei1_hollis', 'nei1_east village', 'nei1_glendale',
            'nei1_morris heights', 'nei1_glen oaks', 'nei1_bensonhurst', 'nei1_bushwick', 'nei1_jamaica',
             'nei1_financial district', 'nei1_flatiron district', 'nei1_middle village', 'nei1_prospect heights',
             'nei1_greenpoint', 'nei1_brighton beach', 'nei1_jackson heights', 'nei1_kensington', 'nei1_flushing',
             'nei1_inwood', 'nei1_jamaica estates', 'nei1_kingsbridge', 'nei1_boerum hill', 'nei1_flatbush',
             'nei1_canarsie', 'nei1_upper east side', 'nei1_flatlands', 'nei1_chelsea', 'nei1_brooklyn heights',
              'nei1_stuyvesant town - peter cooper village', 'nei1_borough park', 'nei1_sheepshead bay',
              'nei1_west harlem', 'nei1_south ozone park', 'nei1_hunts point', 'nei1_noho', 'nei1_park slope',
              'nei1_highbridge', 'nei1_windsor terrace', 'nei1_roosevelt island', 'nei1_east harlem', 'nei1_rego park',
              'nei1_bedford park', 'nei1_ridgewood', 'nei1_east tremont', 'nei1_cobble hill', 'nei1_unionport',
              'nei1_far rockaway', 'nei1_ozone park', 'nei1_central park', 'nei1_bath beach', 'nei1_astoria',
              'nei1_elmhurst', 'nei1_gowanus', 'nei1_parkchester', 'nei1_lower east side', 'nei1_mott haven',
              'nei1_norwood', 'nei1_tribeca', 'nei1_chinatown', 'nei1_midtown', 'nei1_clinton hill', 'nei1_whitestone',
               'nei1_marine park', 'nei1_morris park', 'nei1_van cortlandt park', 'nei1_sunset park',
               'nei1_garment district', 'nei1_woodside', 'nei1_briarwood', 'nei1_maspeth', 'nei1_bay ridge',
                'nei1_bayside', 'nei1_gramercy park', 'nei1_sunnyside', 'nei1_carroll gardens', 'nei1_williamsburg',
                 'nei1_mount hope', 'nei1_pelham bay', 'nei1_battery park city', 'nei1_west village',
                 'nei1_greenwood heights', 'nei1_brownsville', 'nei1_ocean hill', "nei1_hell's kitchen",
                  'nei1_dumbo', 'nei1_east flatbush', 'nei1_washington heights', 'nei1_east elmhurst',
                   'nei1_harlem', 'nei1_greenwich village', 'nei1_crown heights', 'nei1_fort greene',
                   'nei1_corona', 'nei1_east new york', 'nei1_soho', 'nei1_upper west side', 'nei1_riverdale',
                    'nei1_woodhaven', 'nei1_kew gardens', 'nei2_not_mapped_yet', 'nei2_northeastern queens',
                    'nei2_northwestern brooklyn', 'nei2_west bronx', 'nei2_southeastern brooklyn',
                    'nei2_northwestern queens', 'nei2_eastern brooklyn', 'nei2_central brooklyn',
                    'nei2_south brooklyn', 'nei2_upper manhattan', 'nei2_east bronx', 'nei2_other',
                    'nei2_midtown manhattan', 'nei2_southeastern queens', 'nei2_southwestern brooklyn',
                     'nei2_southern brooklyn', 'nei2_rockaway peninsula', 'nei2_southwestern queens',
                      'nei2_northern brooklyn', 'nei2_downtown manhattan', 'nei3_not_mapped_yet', 'nei3_manhattan',
                       'nei3_brooklyn', 'nei3_bronx', 'nei3_queens', 'mngr_activity_prev_num_in_3600.0_secs',
                        'mngr_activity_prev_num_in_1800.0_secs', 'mngr_activity_prev_num_in_86460.0_secs',
                        'mngr_activity_next_num_in_3600.0_secs', 'mngr_activity_next_num_in_1800.0_secs',
                        'mngr_activity_next_num_in_86460.0_secs']
"""
