...
def add_log_reg_cols_big_small(big, small, prior, update_df, variable):
    ...
    big_arr = big[['man_id_count', 'man_id_high', 'man_id_medium', 'man_id_low']]
    small_arr = small[['man_id_count', 'man_id_high', 'man_id_medium', 'man_id_low']]
...
do_test_with_xgboost_stats_per_tree(1000, 'mnfr_ens_and_count_test', sys.argv[1])