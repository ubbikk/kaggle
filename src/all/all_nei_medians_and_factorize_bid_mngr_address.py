...
#FACTORIZE MNGR, BID, DISPLAy/STREET ADDRESS
...
def loss_with_per_tree_stats(df, new_cols):
    ...
    train_df, test_df, new_cols = process_mangr_etc_factorize(train_df, test_df)
    features+=new_cols
    print train_df[new_cols].head(20)
    print test_df[new_cols].head(20)
...
do_test_with_xgboost_stats_per_tree(1000, 'all_nei_medians_and_factorize_bid_mngr_address')
