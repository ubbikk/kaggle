...
def with_m_loss(df, m):
    ...
    features = ['bathrooms', 'bedrooms', 'latitude', 'longitude', 'price',
               ...
               cols_forM(col, TARGET, TARGET_VALUES, m)

    train_df, test_df = split_df(df, 0.7)
    train_df, test_df = processM(train_df, test_df, col, TARGET, TARGET_VALUES, m)
...
for m in (2, 5, 50, 100, 3, 10, 20, 30):
    do_test(200, '/home/dpetrovskyi/PycharmProjects/kaggle/trash/building_id__m_{}.json'.format(m), m)
