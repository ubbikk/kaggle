...
def loss_with_per_tree_stats(train_df, test_df, new_cols):
    ...
    seed = int(time())
    print 'Light seed {}'.format(seed)
    estimator = lgb.LGBMClassifier(n_estimators=1000,
                                   subsample=0.8,
...
def do_test_xgboost(name, mongo_host, experiment_max_time=15*60):
    ...
    for counter in range(15):
        ...
        ii_importance.append(importance)
...
do_test_xgboost('stacking_light_gbm_all', '10.20.0.144')#sys.argv[1]
